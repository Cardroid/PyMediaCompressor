...
def add_metadata_args(ffmpegArgs: FFmpegArgs):
    ...
    if is_ver_tag_exist:
        ...
        elif ffmpegArgs.encode_option.max_height > 0 and ffmpegArgs.video_stream.get("height", ffmpegArgs.encode_option.max_height) > ffmpegArgs.encode_option.max_height:
